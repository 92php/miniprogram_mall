...
class Pay
{
    ...
    private function makeWxPreOrder($totalPrice)
    {
        ...
        $wxOrderData->SetTotal_fee($totalPrice * 100); //支付总金额
        $wxOrderData->SetBody('杂货店');
    ...
    private function sign($wxOrder)
    {
        ...
        $jsApiPayData->SetAppid(config('weixin.app_id')); //小程序appid
        $jsApiPayData->SetTimeStamp((string)time()); //时间戳
